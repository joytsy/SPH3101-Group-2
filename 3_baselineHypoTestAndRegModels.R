...
mod2 <- lm(data$stigma_score~data$a1_q28___1+data$a1_q28___3+data$a1_q28___4+
             data$a1_q28___5+data$a1_q28___8+data$a1_type_tb+data$a1_prov+data$a1_operat_dist)
summary(mod2)

mod3 <- lm(data$stigma_score~data$a1_q28___1+data$a1_q28___3+data$a1_q28___4+
             data$a1_q28___5+data$a1_q28___8+data$a1_type_tb+data$a1_operat_dist)
summary(mod3)

mod4 <- lm(data$stigma_score~data$a1_q28___1+data$a1_q28___4+
             data$a1_q28___5+data$a1_q28___8+data$a1_type_tb+data$a1_operat_dist)
summary(mod4)

mod5 <- lm(data$stigma_score~data$a1_q28___1+data$a1_q28___4+
             data$a1_q28___5+data$a1_q28___8+data$a1_type_tb)
summary(mod5)

mod6 <- lm(data$stigma_score~data$a1_q28___1+data$a1_q28___4+
             data$a1_q28___5+data$a1_q28___8)
summary(mod6)

mod7 <- lm(data$stigma_score~data$a1_q28___1+
             data$a1_q28___5+data$a1_q28___8)
summary(mod7)
...
m2 <- glm(data$stigma_thresNumber~data$a1_q28___1+data$a1_q28___3+data$a1_q28___4+data$a1_q28___7+
            data$a1_q28___5+data$a1_q28___8+data$a1_prov+data$a1_operat_dist, family='binomial')
summary(m2)

m3 <- glm(data$stigma_thresNumber~data$a1_q28___1+data$a1_q28___3+data$a1_q28___4+data$a1_q28___7+
            data$a1_q28___5+data$a1_q28___8+data$a1_operat_dist, family='binomial')
summary(m3)

m4 <- glm(data$stigma_thresNumber~data$a1_q28___1+data$a1_q28___4+data$a1_q28___7+
            data$a1_q28___5+data$a1_q28___8+data$a1_operat_dist, family='binomial')
summary(m4)

m5 <- glm(data$stigma_thresNumber~data$a1_q28___1+data$a1_q28___4+data$a1_q28___7+
            data$a1_q28___5+data$a1_q28___8+data$a1_operat_dist, family='binomial')
summary(m5)

m6 <- glm(data$stigma_thresNumber~data$a1_q28___1+data$a1_q28___7+
            data$a1_q28___5+data$a1_q28___8+data$a1_operat_dist, family='binomial')
summary(m6)
